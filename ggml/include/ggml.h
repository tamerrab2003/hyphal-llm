...
extern "C" {
    ...
    enum ggml_op {
        ...
        GGML_OP_SSM_CONV,
        GGML_OP_HYPHAL_ATTEND,    /* HyphalLLM: sparse bio-inspired attention */
        GGML_OP_PHYSARUM_ROUTE,   /* HyphalLLM: Physarum head conductance gate */
        GGML_OP_SSM_SCAN,
        GGML_OP_WIN_PART,
        GGML_OP_WIN_UNPART,
        GGML_OP_GET_REL_POS,
    ...
    /* HyphalLLM: parameters for GGML_OP_HYPHAL_ATTEND */
    typedef struct {
        int32_t num_heads;
        int32_t head_dim;
        int32_t max_active_nodes;
        float   surprise_threshold;
        int32_t layer_idx;
        float   conductance_decay;
        int32_t zone;              /* 0=ssm 1=gate 2=full */
        int32_t session_id;
    } ggml_hyphal_params_t;
