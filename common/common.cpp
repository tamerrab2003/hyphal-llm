...
struct llama_context_params common_context_params_to_llama(const common_params & params) {
    ...
    // HyphalLLM: wire through hyphal options
    cparams.n_hyphal_nodes   = params.hyphal_nodes > 0 ? params.hyphal_nodes : 0;
    cparams.hyphal_load_path = params.hyphal_load_path.empty()
                                ? nullptr : params.hyphal_load_path.c_str();
    cparams.hyphal_save_path = params.hyphal_save_path.empty()
                                ? nullptr : params.hyphal_save_path.c_str();
